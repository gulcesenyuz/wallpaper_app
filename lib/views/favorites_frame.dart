...
class FavoritesFrame extends StatefulWidget {
  @override
  _FavoritesFrameState createState() => _FavoritesFrameState();
}

class _FavoritesFrameState extends State<FavoritesFrame>
            ...
            child: GestureDetector(
              ...
              child: AbsorbPointer(
                ...
                child: Material(
                  ...
                  child: FavoritesScreen(menuCallback: (){
                    setState(() {
                      menuOpen = true;
